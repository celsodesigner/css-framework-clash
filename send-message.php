...
$Email->Host = "mail.celsoferreira.com.br"; // Endere�o do servidor SMTP (caso queira utilizar a autentica��o, utilize o host smtp.seudom�nio.com.br)
$Email->SMTPAuth = true; // Usar autentica��o SMTP (obrigat�rio para smtp.seudom�nio.com.br)
$Email->Port = 587;
$Email->Username = 'contato@clashdesign.com.br'; // Usu�rio do servidor SMTP (endere�o de email)
$Email->Password = 'celsogudjme89'; // Senha do servidor SMTP (senha do email usado)

$Email->IsHTML(true); 
//$mail->CharSet = 'UTF-8';
$Email->From = $email; 
$Email->FromName = utf8_decode($_POST['nome']);
$Email->AddAddress("contato@clashdesign.com.br"); 
$Email->Subject = utf8_decode ("Mensagem Enviada Através do Formulário Site Clash Design"); 
//$Email->AddBcc($email); 
